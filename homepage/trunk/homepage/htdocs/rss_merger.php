...
$cached_rss = ''; 						/*  The cache RSS file that will be created */

$xml_encoding = 'UTF-8';								/* The encoding you want the final XML file to have */
$num_of_items = '20';									/* The number of items it will collect from each feed, counted off the top of the RSS feed. */
